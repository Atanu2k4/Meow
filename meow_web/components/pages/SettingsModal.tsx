                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center gap-6">
                                        <div className="relative group shrink-0">
                                            <div className="w-20 h-20 rounded-[1.2rem] overflow-hidden border border-foreground/10 shadow-sm bg-foreground/5 hover:border-foreground/30 transition-all">
                                                <img
                                            ...
                                            <button
                                                ...
                                                className="absolute -bottom-2 -right-2 p-2 bg-background border border-foreground/10 rounded-full shadow-md text-foreground hover:scale-110 active:scale-95 transition-all z-10"
                                            >
                                        ...
                                        <div className="flex flex-col gap-2 flex-1">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-transparent border-b border-foreground/10 focus:border-foreground/40 px-1 py-3 outline-none transition-all placeholder:opacity-20 text-xl font-medium"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <AnimatePresence>
                                        {isEditingAvatar && (
                                            ...
                                            >
                                                <label className="text-xs font-bold opacity-60 px-1 pt-2">Choose Avatar</label>
                                                <div className="grid grid-cols-4 xs:grid-cols-8 gap-3 p-5 bg-foreground/5 rounded-3xl border border-foreground/10 shadow-inner">
                                                    {avatars.map((avatar) => (
                                                        <button
                                                            key={avatar}
                                                            onClick={() => {
                                                            ...
                                                            className={`relative aspect-square rounded-xl overflow-hidden transition-all hover:scale-110 active:scale-95 ${selectedAvatar === avatar
                                                                ? 'ring-2 ring-foreground shadow-xl scale-110 z-10 bg-background/50'
