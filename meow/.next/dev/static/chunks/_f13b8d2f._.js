...
function CatEyes({ baseMood }) {
    ...
    // Sync prop changes to state, but allow internal overrides
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
                ...
                "CatEyes.useEffect.behaviorLoop": ()=>{
                    ...
                    timeoutRef.current = setTimeout({
                        "CatEyes.useEffect.behaviorLoop": ()=>{
                            ...
                            // 1. Blink (30% chance)
                            if (action < 0.3) {
                                const prevMood = currentMood; // Capture current mood before blink
                                setCurrentMood("blink");
                                setTimeout({
                                    "CatEyes.useEffect.behaviorLoop": ()=>{
                                        // restore to base mood, not the potentially transient 'look' mood
                                        setCurrentMood(baseMood);
                                    }
                                }["CatEyes.useEffect.behaviorLoop"], 150);
                            } else if (action < 0.7 && baseMood !== "angry") {
                                const lookDir = Math.random() > 0.5 ? "look-left" : "look-right";
                                setPupilOffset({
                                    x: lookDir === "look-left" ? -15 : 15,
                                    y: Math.random() * 10 - 5
                                });
                                // Reset look after short time
                                setTimeout({
                            ...
                            } else if (baseMood === "happy" && action > 0.8) {
                                setCurrentMood("surprised"); // briefly surprised/excited
                                setTimeout({
                                    "CatEyes.useEffect.behaviorLoop": ()=>setCurrentMood("happy")
                                }["CatEyes.useEffect.behaviorLoop"], 600);
                            }
                            behaviorLoop(); // Recursive loop
                        }
        ...
        baseMood
    ]); // Re-start loop when base mood changes
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                children: `.eyes-container.__jsx-style-dynamic-selector{justify-content:center;align-items:center;gap:30px;margin-bottom:20px;display:flex}.eye.__jsx-style-dynamic-selector{width:90px;height:90px;transform:translate(${pupilOffset.x}px,${pupilOffset.y}px);background:#fff;border-radius:18px;transition:all .4s cubic-bezier(.34,1.56,.64,1);position:relative;overflow:hidden}.normal.__jsx-style-dynamic-selector{border-radius:18px;height:90px}.happy.__jsx-style-dynamic-selector{background:linear-gradient(#fff 50% 50%);border-radius:50% 50% 12px 12px;height:60px;margin-top:30px}.happy.__jsx-style-dynamic-selector:after{content:"";background:#000;border-radius:50% 50% 0 0;width:100%;height:40%;position:absolute;bottom:0;left:0}.angry.__jsx-style-dynamic-selector{border-radius:12px;height:80px}.angry.left.__jsx-style-dynamic-selector{transform:rotate(-15deg)translate(${pupilOffset.x}px,${pupilOffset.y}px)}.angry.right.__jsx-style-dynamic-selector{transform:rotate(15deg)translate(${pupilOffset.x}px,${pupilOffset.y}px)}.angry.__jsx-style-dynamic-selector:before{content:"";background:#000;height:50px;position:absolute;top:-20px;left:-20px;right:-20px;transform:rotate(10deg)}.angry.right.__jsx-style-dynamic-selector:before{transform:rotate(-10deg)}.surprised.__jsx-style-dynamic-selector{border-radius:50%;width:100px;height:100px;transform:scale(1.1)}.blink.__jsx-style-dynamic-selector{border-radius:2px;margin-top:43px;width:90px!important;height:4px!important;transform:none!important}.blink.__jsx-style-dynamic-selector:before,.blink.__jsx-style-dynamic-selector:after{display:none}`
...
_s(CatEyes, "MQdTTvOZdzTRVeuH2yGtY0wqImw=");
_c = CatEyes;
var _c;
...
//# sourceMappingURL=_f13b8d2f._.js.map